...
System.out.println(Arrays.toString(outer.getFilesInDir("com/journaldev/nested", ".java")));

System.out.println(Arrays.toString(outer.getFilesInDir("com/journaldev/nested", ".class")));
}
